...
The [provider-natssecrets](https://github.com/edgefarm/provider-natssecrets) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-natssecrets](https://github.com/crossplane-contrib/provider-jet-natssecrets) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/edgefarm/provider-natssecrets/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/edgefarm/provider-natssecrets/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/edgefarm/provider-natssecrets/blob/main/hack/boilerplate.go.txt](https://github.com/edgefarm/provider-natssecrets/blob/main/hack/boilerplate.go.txt)
...
The [provider-natssecrets](https://github.com/edgefarm/provider-natssecrets)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/edgefarm/provider-natssecrets/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/edgefarm/provider-natssecrets/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue natssecretss (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/edgefarm/provider-natssecrets/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request NatsSecretss: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/edgefarm/provider-natssecrets/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
