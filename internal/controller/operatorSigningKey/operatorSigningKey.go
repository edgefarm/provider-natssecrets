...
const (
	errNotOperatorSigningKey = "managed resource is not a Operator Signing Key custom resource"
...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(v1alpha1.OperatorSigningKeyGroupKind)
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(v1alpha1.OperatorSigningKeyGroupVersionKind),
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.OperatorSigningKey{}).
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	...
	if !ok {
		return nil, errors.New(errNotOperatorSigningKey)
	}
...
func (c *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	...
	key := cr.Name
	data, err := nkey.ReadOperatorSigningKey(c.client, operator, key)
	if err != nil {
	...
	cr.Status.AtProvider.NKey = nkey.OperatorSigningKeyPath(c.client.Mount, operator, key)
...
func (c *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.OperatorSigningKey)
	if !ok {
		return managed.ExternalCreation{}, errors.New(errNotOperatorSigningKey)
	}
...
func (c *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.OperatorSigningKey)
	if !ok {
		return managed.ExternalUpdate{}, errors.New(errNotOperatorSigningKey)
	}
...
func (c *external) Delete(ctx context.Context, mg resource.Managed) error {
	cr, ok := mg.(*v1alpha1.OperatorSigningKey)
	if !ok {
		return errors.New(errNotOperatorSigningKey)
	}
