# ====================================================================================
# Setup Project
PROJECT_NAME := provider-natssecrets
PROJECT_REPO := github.com/edgefarm/$(PROJECT_NAME)
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider NatsSecrets CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider NatsSecrets controllers
...
# This target prepares repo for your provider by replacing all "natssecrets"
